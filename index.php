...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Welcome CSV2.php WACHOOOO</h1>
...
$rutaArchivo = "C:\\xampp\\htdocs\\app\\Views\\PROBANDO\\solo100.csv";
$openfile = fopen($rutaArchivo, "r");
$cont = fread($openfile, filesize($rutaArchivo));
//echo $cont;
fclose ($openfile);
...
//csvMostrar($rutaArchivo);



arrayDeColumna($rutaArchivo, 1);
...
function csvMostrar($rutaArchivo){
    echo ("Función csvMostrar :");
...
function arrayDeColumna($rutaArchivo, $numCol){
    echo ("Función arrayDeColumna :");
    ...
    <section>
        ...
        <h2>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 130 130'>
                ...
                <rect x='0' y='0' width='80' height='80' rx='0' ry='0' style='fill:none;stroke:#ffaa00;stroke-linejoin:round;stroke-width:12px'/>

               
                <line x1='0' y1='0' x2='130' y2='130' style='fill:none;stroke:#ffaaff;stroke-linecap:round;stroke-miterlimit:10;stroke-width:5px'/>
